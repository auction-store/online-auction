...
class Sell extends React.Component {
  ...
  handleInputChange(event) {
    ...
    if (name == "city") {
      //   let selectedCity = this.state.locations.find(
      //     (location) => location.city === value
      //   );
      let selectedCity = "AAA";
  ...
  validate() {
    ...
    if (this.state.endDate < Date.now() + minimumSaleDuration) {
      validationErrors.endDate =
        "Kapanış tarihi en erken 12 saat sonra olabilir.";
      validated = false;
    }
          ...
          <Form onSubmit={this.handleSubmit}>
            <div className="row">
              <div className="col-md-4">
                <FormGroup>
                  ...
                  <Input
                    ...
                    placeholder="A few words that describe your product"
                  />
                ...
                <FormGroup>
                  ...
                  <Input
                    ...
                    onBlur={this.handleInputBlur}
                    style={{ outline: "none" }}
                    placeholder="Descriptions about your product and extra information you want to specify."
                  />
                  <ValidationError
                    message={this.state.validationErrors.description}
                  />
                  {this.state.focuses.description &&
                ...
                <FormGroup>
                  <Label for="firstPrice">Starting Price</Label>
                  <InputGroup>
                ...
                <FormGroup>
                  <Label style={{ display: "block" }} for="endDate">
                    Closing Date
                  </Label>
                  <InputGroup>
                    <InputGroupAddon addonType="prepend">
                ...
                <FormGroup>
                  <Label style={{ textDecoration: "underline" }} for="location">
                    Location
                  </Label>
                  <div className="row" id="location">
                    ...
                    <div className="col-md-6">
                      ...
                      >
                        ...
                        <option>SanFransisco</option>
                        <option>NewJergy</option>
                        <option>Hawai</option>
                      </Input>
                    </div>
                  </div>
              ...
              <div className="col-md-8">
                <FormGroup>
                  <Label style={{ display: "block" }} for="filepond">
                    Product Photos
                  </Label>
                  <FilePond
                    id="filepond"
                    ...
                    labelIdle="Drag and drop, or click to install from your computer. You can upload up to 10 photos."
                    ...
                    labelFileProcessing="Fotoğraf Loading"
