...
class Login extends React.Component {
  constructor(props) {
    super(props);
    const message = this.props.registered
        ...
        function (error) {
          if (error.response) {
            ...
            this.setState({
              alert: {
                message:
                  "Sunucudaki bir sorundan dolayı kayıt işleminizi şu anda gerçekleştiremiyoruz.",
                color: "info",
              },
            });
          }
            ...
            <div className="col-md-4">
                ...
                {true ? (
                  ...
                  <p>
                    <Link href={"/forget-password"}>
                      <a className="text-dark "> I forgot my password</a>
                    </Link>
                  </p>
                )}
                <Button
              ...
              <p>
                ...
                <Link href={"/registration"}>
                  <a className="text-dark"> Become a member</a>
                </Link>
              </p>
            </div>
          </div>
